...
describe('colorScheme', () => {
    describe('convertToSublimeColorScheme', () => {
        it('should be defined', () => {
            expect(colorScheme_1.convertToSublimeColorScheme).toBeDefined();
        });
        it('should create sublime plist', () => {
            ...
            expect(colorScheme_1.convertToSublimeColorScheme(mockCodeTheme, 'c793f1b7-f404-4166-8768-472123631119')).toMatchInlineSnapshot(`
